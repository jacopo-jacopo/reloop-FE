...
function LoginComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14, " \u{1F4A1} Accedendo con un dominio ");
    \u0275\u0275elementStart(15, "strong");
    \u0275\u0275text(16, "@reloop.it");
    \u0275\u0275elementEnd();
    \u0275\u0275text(17, " si entrer\xE0 nella Dashboard Amministratore. ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function LoginComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(10, "option", 37);
    \u0275\u0275text(11, "Seleziona citt\xE0...");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(12, LoginComponent_Conditional_10_For_13_Template, 2, 2, "option", 38, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(17, "Quartiere");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "select", 39)(19, "option", 37);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(21, LoginComponent_Conditional_10_For_22_Template, 2, 2, "option", 38, _forTrack0);
    \u0275\u0275elementEnd();
...
var LoginComponent = class _LoginComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 84, vars: 9, consts: [[1, "login-pg", "act"], [1, "login-left"], [1, "ll-logo"], ["src", "LOGO_LIME.png", "alt", "reloop", 1, "logo-login"], [1, "tab-row"], [1, "tab-btn", 3, "click"], [1, "lform", 3, "formGroup"], [1, "login-right"], [1, "lr-tag"], [1, "lr-tag-dot"], [1, "lr-h"], [1, "lr-sub"], [1, "stats-strip", "u-mb28"], [1, "ss-item"], [1, "ss-n"], [1, "ss-l"], [1, "flow"], [1, "flow-step", "flow-lime"], [1, "fs-n"], [1, "fs-ico"], [1, "fs-t"], [1, "fs-d"], [1, "flow-step", "flow-sage"], [1, "flow-step", "flow-amber"], [1, "flow-step", "flow-terra"], [1, "lr-chips"], [1, "lr-chip"], [1, "lform", 3, "ngSubmit", "formGroup"], [1, "fg"], [1, "fl"], ["type", "email", "formControlName", "email", "placeholder", "esempio@dominio.com", 1, "fi"], [1, "ferr", "show"], ["type", "password", "formControlName", "password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", 1, "fi"], ["type", "submit", 1, "btn-login", 3, "disabled"], [1, "admin-login-note", "u-text-center"], ["type", "text", "formControlName", "nome_completo", "placeholder", "Mario Rossi", 1, "fi"], ["formControlName", "citta", 1, "fi", 3, "change"], ["value", ""], [3, "value"], ["formControlName", "id_quartiere", 1, "fi"], ["type", "text", "formControlName", "indirizzo", "placeholder", "Via Roma 12", 1, "fi"], ["type", "password", "formControlName", "password", "placeholder", "min. 8 caratteri", 1, "fi"], ["type", "password", "formControlName", "password2", "placeholder", "ripeti password", 1, "fi"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, "Registrati");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(9, LoginComponent_Conditional_9_Template, 18, 9, "form", 6)(10, LoginComponent_Conditional_10_Template, 46, 25, "form", 6);
      \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-JVU552LO.js.map
