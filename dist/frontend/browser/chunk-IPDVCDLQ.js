...
function AdminComponent_For_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.testoStato(s_r3.stato_segnalazione));
    \u0275\u0275advance(2);
...
function AdminComponent_Conditional_16_Conditional_10_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 31);
  }
  if (rf & 2) {
    const f_r4 = ctx.$implicit;
    \u0275\u0275property("src", f_r4, \u0275\u0275sanitizeUrl);
  }
}
function AdminComponent_Conditional_16_Conditional_10_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27);
    \u0275\u0275repeaterCreate(1, AdminComponent_Conditional_16_Conditional_10_Conditional_5_For_2_Template, 1, 1, "img", 31, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.fotoAnnuncio());
  }
}
function AdminComponent_Conditional_16_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, AdminComponent_Conditional_16_Conditional_10_Conditional_5_Template, 3, 0, "div", 27);
    \u0275\u0275elementStart(6, "div", 28)(7, "strong");
    \u0275\u0275text(8, "Categoria:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 28)(11, "strong");
    \u0275\u0275text(12, "Condizioni:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 28)(15, "strong");
    \u0275\u0275text(16, "Valore stimato:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 29)(19, "strong");
    \u0275\u0275text(20, "Pubblicato da:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 30)(23, "strong");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.fotoAnnuncio().length > 0 ? 5 : -1);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" ", (tmp_7_0 = ctx_r0.annuncioAttivo().pubblicante) == null ? null : tmp_7_0.nome_completo, " (ID #", (tmp_7_0 = ctx_r0.annuncioAttivo().pubblicante) == null ? null : tmp_7_0.id_utente_reg, ") ");
    \u0275\u0275advance(4);
...
function AdminComponent_Conditional_16_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 23)(1, "div", 32);
...
function AdminComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, AdminComponent_Conditional_16_Conditional_10_Template, 26, 8, "div", 22)(11, AdminComponent_Conditional_16_Conditional_11_Template, 8, 0, "div", 23)(12, AdminComponent_Conditional_16_Conditional_12_Template, 2, 0, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.testoStato(ctx_r0.segnalazioneAttiva().stato_segnalazione), " ");
    \u0275\u0275advance(4);
...
//# sourceMappingURL=chunk-IPDVCDLQ.js.map
