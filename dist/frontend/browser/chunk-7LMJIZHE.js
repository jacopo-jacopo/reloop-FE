...
function ProfiloComponent_Conditional_9_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProfiloComponent_Conditional_9_For_3_Template_div_click_0_listener() {
      const ann_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.vaiAllaChat(ann_r6));
    });
    \u0275\u0275elementStart(1, "div", 41);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ProfiloComponent_For_29_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfiloComponent_For_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, ProfiloComponent_For_29_Conditional_9_Template, 7, 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const b_r10 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c0, b_r10.colore, ctx_r1.isSbloccato(b_r10.nome_badge) ? "unlocked" : "locked"));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSbloccato(b_r10.nome_badge) ? 1 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("src", "badges/" + b_r10.icona_badge, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r10.nome_badge);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r10.descrizione_badge);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.isSbloccato(b_r10.nome_badge) && b_r10.soglia_punti !== null ? 9 : -1);
  }
}
...
function ProfiloComponent_For_37_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", u_r12.foto_profilo, \u0275\u0275sanitizeUrl);
  }
}
function ProfiloComponent_For_37_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ProfiloComponent_For_37_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfiloComponent_For_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProfiloComponent_For_37_Template_div_click_0_listener() {
      const u_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.apriProfiloUtente(u_r12.id_utente_reg));
    });
    ...
    \u0275\u0275template(7, ProfiloComponent_For_37_Conditional_7_Template, 1, 1, "img", 68)(8, ProfiloComponent_For_37_Conditional_8_Template, 1, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 69)(10, "div", 70);
    \u0275\u0275text(11);
    \u0275\u0275template(12, ProfiloComponent_For_37_Conditional_12_Template, 2, 0, "span", 71);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(u_r12.id_utente_reg === ((tmp_15_0 = ctx_r1.profilo()) == null ? null : tmp_15_0.id_utente_reg) ? 12 : -1);
    \u0275\u0275advance(2);
...
function ProfiloComponent_For_43_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 68);
  }
  if (rf & 2) {
    const r_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", r_r14.recensore.foto_profilo, \u0275\u0275sanitizeUrl);
  }
}
function ProfiloComponent_For_43_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ProfiloComponent_For_43_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    ...
    const r_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275textInterpolate1(" ", s_r15 <= r_r14.voto ? "\u2605" : "\u2606", " ");
  }
}
function ProfiloComponent_For_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "div", 74)(2, "div", 75);
    \u0275\u0275template(3, ProfiloComponent_For_43_Conditional_3_Template, 1, 1, "img", 68)(4, ProfiloComponent_For_43_Conditional_4_Template, 1, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 76);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 77);
    \u0275\u0275repeaterCreate(8, ProfiloComponent_For_43_For_9_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(r_r14.recensore.foto_profilo ? 3 : 4);
    \u0275\u0275advance(3);
...
function ProfiloComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 82)(5, "strong");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "br");
    \u0275\u0275text(8);
...
var ProfiloComponent = class _ProfiloComponent {
  ...
  apriProfiloUtente(idUtente) {
    this.overlayService.apriUtente(idUtente);
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfiloComponent, selectors: [["app-profilo"]], decls: 46, vars: 13, consts: [[1, "prof-layout"], [1, "prof-sidebar"], [1, "prof-card", "u-text-center"], [1, "u-text-muted-sm"], [1, "prof-ann-card"], [1, "prof-ann-t"], [1, "u-text-muted-sm", 2, "margin-top", "8px"], [1, "prof-ann-t", 2, "margin-top", "18px"], [1, "u-text-note2-mb14"], [1, "active-ann", "segnala-item"], [1, "u-text-xs-muted"], [1, "badge-sec"], [1, "badge-sec-hdr"], [1, "badge-sec-t"], [1, "badge-cnt"], [1, "badges-grid"], [1, "badge-card", 3, "ngClass"], [1, "u-text-muted-sm", 2, "grid-column", "1/-1"], [1, "lb-sec"], [1, "lb-t"], [1, "lb-sub"], [1, "lb-row", "lb-row-click", 3, "you"], [1, "reviews-sec"], [1, "reviews-t"], [1, "rev-item"], [1, "modal-bg", "open"], [1, "prof-av"], [2, "width", "100%", "height", "100%", "object-fit", "cover", "border-radius", "50%", 3, "src"], [1, "prof-name"], [1, "prof-loc"], [1, "prof-score-box"], [1, "prof-score-n"], [1, "prof-score-l"], [1, "prof-stats"], [1, "pstat"], [1, "pstat-n"], [1, "pstat-l"], [1, "btn-outline", 2, "width", "100%", "margin-top", "14px", "font-size", ".82rem", 3, "click"], [1, "u-section-label"], [1, "active-ann", "clickable"], [1, "active-ann", "clickable", 3, "click"], [1, "active-ann-ico"], [1, "active-ann-name"], [1, "active-ann-s"], [1, "u-section-label-mt"], [1, "active-ann-s", "u-clr-amber"], [1, "active-ann", "u-opacity55"], [1, "active-ann-s", "u-clr-txt3"], [1, "active-ann-s", 2, "color", "var(--terra)"], ["routerLink", "/pubblica", 2, "color", "var(--lime)"], [1, "u-flex1", "segnala-body"], [1, "active-ann-name", "segnala-title"], [1, "u-text-xs-muted", "segnala-nota"], [1, "active-ann-s", "segnala-stato"], [1, "badge-stamp"], [1, "badge-top"], [1, "badge-emo"], [1, "badge-emo-img", 3, "src"], [1, "badge-name"], [1, "badge-desc"], [1, "badge-bar-t"], [1, "badge-bar-f"], [1, "badge-pct"], [1, "u-clr-sage"], [1, "lb-row", "lb-row-click", 3, "click"], [1, "lb-med"], [1, "lb-rank", "u-opacity40"], [1, "lb-av", "av-lime"], [1, "av-img", 3, "src"], [1, "lb-user"], [1, "lb-uname"], [1, "lb-you-tag"], [1, "lb-uinfo"], [1, "lb-score"], [1, "rev-hdr"], [1, "rev-av", "av-sage"], [1, "rev-name"], [1, "rev-stars"], [1, "rev-txt"], [1, "modal-bg", "open", 3, "click"], [1, "modal", 3, "click"], [1, "modal-h"], [1, "modal-p"], [1, "modal-acts", 2, "flex-direction", "column", "gap", "8px"], [1, "btn-cancel2", 3, "click"], [1, "btn-confirm", 2, "background", "var(--terra)", "color", "#fff", 3, "click"]], template: function ProfiloComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(28, ProfiloComponent_For_29_Template, 10, 9, "div", 16, _forTrack1, false, ProfiloComponent_ForEmpty_30_Template, 2, 0, "p", 17);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(36, ProfiloComponent_For_37_Template, 17, 8, "div", 21, _forTrack2, false, ProfiloComponent_ForEmpty_38_Template, 2, 0, "p", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "div", 22)(40, "div", 23);
      \u0275\u0275text(41, "\u2B50 Recensioni ricevute");
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(42, ProfiloComponent_For_43_Template, 12, 4, "div", 24, _forTrack3, false, ProfiloComponent_ForEmpty_44_Template, 2, 0, "p", 3);
      \u0275\u0275elementEnd()()();
